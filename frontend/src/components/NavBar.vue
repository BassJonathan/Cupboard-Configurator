  ...
  >
    <div class="tw-inline-block lg:tw-h-12">
      <a href="/">
        <img
          ...
          alt="Cupboard Ltd."
          class="tw-h-full tw-inline-block tw-my-4 tw-ml-8 tw-mr-5"
        />
        <span
          class="
            tw-text-white
    ...
    <div class="tw-text-white tw-inline-block tw-my-auto">
      <nav>
        <ul>
          <li
            class="tw-inline-block nav_font tw-px-2 xl:tw-text-lg lg:tw-text-md"
          >
          ...
          <li
            class="tw-inline-block nav_font tw-px-2 xl:tw-text-lg lg:tw-text-md"
          >
            <router-link to="/goal">{{ t("NavBar.goal") }}</router-link>
          </li>
          <li
            class="tw-inline-block nav_font tw-px-2 xl:tw-text-lg lg:tw-text-md"
          >
            <router-link to="/about">{{ t("NavBar.about_us") }}</router-link>
          </li>
          <li
            class="tw-inline-block nav_font tw-px-2 xl:tw-text-lg lg:tw-text-md"
          >
            <router-link to="/imprint">{{ t("NavBar.imprint") }}</router-link>
          </li>
          <li
            class="tw-inline-block nav_font tw-px-2 xl:tw-text-lg lg:tw-text-md"
          >
          ...
          >
            <div class="dropdown">
              ...
              <ul
                class="dropdown-menu"
                aria-labelledby="dropdownMenuButtonCurrency"
                style="width: 20px !important"
              >
                <li>
                  <a
                    class="dropdown-item tw-pl-8"
                    :class="{ highlight: currency == 'de' }"
                    @click="changeC('de')"
                    >€ &nbsp;| Euro</a
                  >
                </li>
