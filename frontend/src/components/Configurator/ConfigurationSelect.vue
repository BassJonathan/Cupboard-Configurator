<template>
    <div class="tw-rounded-xl tw-p-5 tw-shadow-lg tw-bg-white">
        <div class="tw-w-full tw-text-2xl tw-font-semibold">
            {{product.name}}
        </div>
        ...
        <div class="tw-w-full tw-text-xl">
            <div v-for="part in product.configuration" :key="part.id">
