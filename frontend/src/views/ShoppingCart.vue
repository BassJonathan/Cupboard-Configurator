<template>
    <div class="tw-mt-20 tw-mx-10">
        ...
        <div v-if="items.length">
            <div class="tw-w-full">
                <table class="tw-table-fixed tw-border-collapse tw-text-left tw-w-full tw-text-xl">
                ...
                <div class="tw-w-full tw-px-10 tw-flex tw-justify-end">
                    <router-link class="btn btn-primary tw-ml-4 tw-float-right" to="/checkout">Zur Kasse gehen</router-link>
                </div>
            </div>
        </div>
        <div v-else class="tw-p-10">
            <p class="tw-text-4xl">Keine Artikel im Warenkorb!</p>
            <p class="tw-text-2xl tw-pt-3 tw-center">Entdecke hier unser großes Sortiment: <router-link class="btn btn-primary tw-ml-4" to="/products">Alle Produkte</router-link></p>
        </div>
    </div>
</template>
